  ...
  )
{
  ...
  *VramSize = SIZE_128MB;
  ...
  // Set Framebuffer base address to a Fixed And Reserved Region.
  // Check Platforms/Rock5bPkg/Library/RK3588Lib/RK3588Mem.c for more.

//  *VramBaseAddress = (EFI_PHYSICAL_ADDRESS)AllocatePool(SIZE_128MB);
  *VramBaseAddress = (EFI_PHYSICAL_ADDRESS)0xC0000000;
