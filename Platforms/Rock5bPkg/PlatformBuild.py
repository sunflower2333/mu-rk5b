# @file
# Script to Build Rock5b UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("Rock5bPkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Rock5b', 'gcc_aarch64_linux', 'edk2-build', 'cibuild')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "Rock5bPkg/Rock5b.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Rock5b", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "Rock5bPkg/Rock5b.dsc", "Platform Hardcoded")
